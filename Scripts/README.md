...
stats_denoised
usearch10 -usearch_global cat.fasta -db cat.denoised -strand plus -id 1.0 -otutabout cat.fasta.table
```
...
perl add_abundance_to_rdp_out4.plx cat.fasta.table cat.denoised.out
