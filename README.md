...
This data flow will be updated on a regular basis so check for the latest version at https://github.com/Hajibabaei-Lab/SCVUS_18S_metabarcode_pipeline/releases .
